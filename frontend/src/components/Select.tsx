  ...
  return (
    <div>
      ...
      >
        ...
        <div className="absolute top-full rounded-md p-3 mt-3  flex flex-col justify-start items-start scale-0 group-focus:scale-100 origin-top duration-200 bg-white outline-1 outline-gray-300 z-20 w-40">
